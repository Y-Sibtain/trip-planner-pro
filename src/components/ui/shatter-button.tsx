...
import React, { useState, useCallback, type ReactNode, type ReactElement } from "react"
...
export default function ShatterButton({
  ...
  // If a single React element is passed as child, clone it and attach shatter behavior
  const renderChild = () => {
    if (React.isValidElement(children)) {
      const child = children as ReactElement & { props: any }
    ...
    // Fallback: render original styled button when no valid child provided
    return (
      <motion.button
